        ...
        HStack {
            ...
            VStack(alignment: .leading) {
                ...
                Text("You can't configure settings in the GUI yet. To modify settings, " +
                     "edit the file at $HOME/Library/Application Support/" +
                     "\(FlashGhosttyProductProfile.releaseBundleIdentifier)/config.ghostty " +
                     "and restart \(FlashGhosttyProductProfile.displayName).")
